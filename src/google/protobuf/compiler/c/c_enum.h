...
class EnumGenerator {
 public:
  ...
  void GenerateValueInitializer(io::Printer *printer, int index,int array_index);

	//MAOLIN
	void GenerateValueDeclarations(io::Printer* printer);
	void GenerateEnumDescriptorAssign(io::Printer* printer);
 private:
