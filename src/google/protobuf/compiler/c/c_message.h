...
class MessageGenerator {
 public:
  ...
  void GenerateHelperFunctionDeclarations(io::Printer* printer,const string& package_name, bool is_submessage);
  ...
  void GenerateHelperFunctionDefinitions(io::Printer* printer,const string& package_name, bool is_submessage);

  // MAOLIN
  void GenerateEnumValueDeclarations(io::Printer* printer);
  void GenerateDescriptorValueDeclarations(io::Printer* printer);
  void GenerateMessageDescriptorAssign(io::Printer* printer);
